            ...
            <li class="nav-item active">
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="afficherListeQuestion.php">Questions</a>
                        <a class="collapse-item" href="afficherListeQuestion_opt.php">Options</a>
...
<!-- End of Topbar -->
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">List of Quiz </h1>
