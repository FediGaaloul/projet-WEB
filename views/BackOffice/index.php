...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="tables paiement.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Payement</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="tables transaction.php">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item">
                <a class="nav-link" href="ListeQuiz.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>List Quiz</span></a>
            </li>
            <li class="nav-item active">
                            <a class="nav-link" href="listT.php">
                                <i class="fas fa-fw fa-table"></i>
                                <span>List ticket</span></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="listi.php">
                                <i class="fas fa-fw fa-table"></i>
                                <span>List interraction</span></a>
                        </li>
